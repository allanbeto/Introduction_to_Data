...
url <- "http://s3.amazonaws.com/assets.datacamp.com/production/course_1800/datasets/us_regions.RData"

#download.file(url, "us_regions.RData")
...
url <- "http://s3.amazonaws.com/assets.datacamp.com/production/course_1800/datasets/evals.RData"

download.file(url, "evals.RData")
